...
return '✹ اصدار سورس ليجاند : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'✹ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ليجاند يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SUORSlegand"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : ليجاند](https://t.me/SUORSlegand)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج ليجاند" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/Xx_LEGAND_xX"}}}
send_key(msg.sender_user_id_,'   [المبرمج ليجاند](https://t.me/Xx_LEGAND_xX)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "بلاك مالك السورس" and msg.type == "pv" then
local inline = {{{text="مالك السورس اضـغـط هـنـآ ",url="https://t.me/B_l_a_c_k_H_o_u_s_e_1"}}}
send_key(msg.sender_user_id_,'   [المالك بلاك](https://t.me/B_l_a_c_k_H_o_u_s_e_1)' ,nil,inline,msg.id_)
return false
end
...
[S𝙾𝚄𝚁𝙲𝙴 f𝙻𝙰𝚂𝙷 𖠲](https://t.me/SUORSlegand) 
                      [ــــــــــــــــــــ𖠲ــــــــــــــــــــــ](https://t.me/SUORSlegand) 
[𝓓𝓔𝓥  𖠞 A𝒅𝒉𝒂𝒎](https://t.me/B_l_a_c_k_H_o_u_s_e_1) 
                      ــــــــــــــــــــ𖠲ــــــــــــــــــــــ
[𝓓𝓔𝓥  𖠞 𝐽𝐴𝐶𝐾](https://t.me/Xx_LEGAND_xX) 
                     [ــــــــــــــــــــ𖠲ــــــــــــــــــــــ](https://t.me/SUORSlegand) 
[S𝙾𝚄𝚁𝙲𝙴 f𝙻𝙰𝚂𝙷 𖠲](https://t.me/SUORSlegand) 
                      ــــــــــــــــــــ𖠲ــــــــــــــــــــــ
...
if Black == 'welcome on' or Black == 'تفعيل الليجاند' then
if redis:get(legand..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الليجاند سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الليجاند')
redis:set(legand..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل ليجاند' then
if redis:get(legand..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل ليجاند سابقا')
redis:set(legand..'welc'..msg.chat_id_,'off')
redis:del(legand..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل ليجاند')
end
end
...
local NUM_MSG_legand = (redis:get(legand..'num_msg_legand'..msg.chat_id_) or 5)
...
elseif Text== "ليجاند" or Text== "ليجاند" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/Xx_LEGAND_xX)")
elseif Text== "بلاك" or Text== "بلاك " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ليجاند ❅](https://t.me/B_l_a_c_k_H_o_u_s_e_1)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/SUORSlegand) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/SUORSlegand)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/SUORSlegand)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/SUORSlegand)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/SUORSlegand)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SUORSlegand) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/SUORSlegand)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SUORSlegand)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SUORSlegand)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SUORSlegand)")
